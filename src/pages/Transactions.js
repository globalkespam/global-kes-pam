...
function Transactions({ user, freTransf }) {
  ...
  const [transFre, setTransFre] = useState(String(freTransf?.enten || 50));
        ...
        <div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '20px' }}>
            <div style={{ background: 'white', borderRadius: '12px', padding: '25px', boxShadow: '0 2px 10px rgba(0,0,0,0.06)' }}>
              ...
              <input value={depoSearch} onChange={e => setDepoSearch(e.target.value)} onKeyPress={e => e.key === 'Enter' && handleDepoSearch()} placeholder="GKP-XXXX" style={inputStyle} />
        ...
        <div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '20px' }}>
            <div style={{ background: 'white', borderRadius: '12px', padding: '25px', boxShadow: '0 2px 10px rgba(0,0,0,0.06)' }}>
              <div style={{ fontSize: '11px', fontWeight: '700', color: '#999', letterSpacing: '1px', marginBottom: '15px' }}>JWENN KLIYAN</div>
              <label style={labelStyle}>Nimewo Kont / Non</label>
              <input value={retreSearch} onChange={e => setRetreSearch(e.target.value)} onKeyPress={e => e.key === 'Enter' && handleRetreSearch()} placeholder="GKP-XXXX" style={inputStyle} />
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr 1fr', gap: '15px', marginBottom: '15px' }}>
              ...
              <div>
                ...
                <div style={{ fontSize: '11px', color: '#999', marginTop: '4px' }}>
                  {transType === 'kont-kont' ? 'Fre enten: HTG ' + (freTransf?.enten || 50) : 'Fre branch: HTG ' + (freTransf?.branch || 150)}
                </div>
              </div>
            </div>
            <div style={{ marginBottom: '20px' }}>
